...
DATASET_CLASS_MAPS: dict[str, dict[str, str]] = {
    ...
    "hands": {
        ...
        "thumb_up": "THUMB_UP",
        "thumb_down": "THUMB_DOWN",
        "point_left": "INDEX_LEFT",
        "pointing_left": "INDEX_LEFT",
        "direction_left": "INDEX_LEFT",
        "left": "INDEX_LEFT",
        "point_right": "INDEX_RIGHT",
        "pointing_right": "INDEX_RIGHT",
        "direction_right": "INDEX_RIGHT",
        "right": "INDEX_RIGHT",
        "two": "PEACE",
        "digit_2": "PEACE",
        "three": "THREE_FINGERS",
        "digit_3": "THREE_FINGERS",
        "ok": "OK_SIGN",
        "ok_sign": "OK_SIGN",
    },
    "jester": {
...
def build_manifest_from_directory(
    ...
    Args:
        ...
        dataset: Dataset preset name, for example ``hands`` or ``own_control``.
